export const en = {
  ...
  home: {
    ...
    slidesText:
      "95 classroom competencies — BC Crane Safety and OHSR Part 15. Clicker, TV cast, offline.",
  ...
  lessons: {
    ...
    introLink: "95-competency slide course",
    introAfter: ".",
  ...
  slides: {
    ...
    competenciesTitle: "What the 95 competencies cover",
