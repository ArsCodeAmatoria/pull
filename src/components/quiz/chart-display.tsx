      ...
      <div className="space-y-4">
        <div className="rounded-lg bg-foreground/5 p-3 sm:p-4">
          ...
          <div className="font-mono text-sm sm:text-base text-foreground">
            Control motion with the <span className="text-foreground font-semibold">motor</span> — hold position with the <span className="text-foreground font-semibold">brake</span>
          </div>
        </div>
        ...
        <div className="rounded-lg bg-foreground/5 p-3 sm:p-4">
          ...
          <div className="font-mono text-sm sm:text-base text-foreground">
            {isFormula ? (
              ...
              <><span className="text-foreground font-semibold">&gt;18 m (60 ft)</span> overlap requires anti-collision</>
            )}
          </div>
        </div>
        <h2 className="font-display text-xl md:text-2xl font-semibold leading-snug">
    ...
    return (
      <div className="space-y-4">
        <div className="rounded-lg bg-foreground/5 p-3 sm:p-4">
          ...
          <div className="font-mono text-sm sm:text-base text-foreground">
            Minimum <span className="text-foreground font-semibold">2 ft</span> from structures
          </div>
        </div>
        <h2 className="font-display text-xl md:text-2xl font-semibold leading-snug">
          {actualQuestion}
    ...
    return (
      <div className="space-y-4">
        <div className="rounded-lg bg-foreground/5 p-3 sm:p-4">
          ...
          <div className="font-mono text-sm sm:text-base text-foreground">
            Minimum <span className="text-foreground font-semibold">10 ft</span> from lines under 50 kV
          </div>
    ...
    return (
      <div className="space-y-4">
        <div className="rounded-lg bg-foreground/5 p-3 sm:p-4">
          ...
          <div className="font-mono text-sm sm:text-base text-foreground">
            <span className="text-foreground font-semibold">5 seconds</span> between flash and thunder ≈ <span className="text-foreground font-semibold">1 mile</span>
          </div>
          <div className="mt-2 text-xs text-muted-foreground">
            Distance = Seconds ÷ 5
          </div>
    ...
    return (
      <div className="space-y-4">
        <div className="rounded-lg bg-foreground/5 p-3 sm:p-4">
          ...
          <div className="font-mono text-sm sm:text-base text-foreground">
            Safe Load = Chart Capacity × (1 - <span className="text-foreground font-semibold">Reduction%</span>)
          </div>
          <div className="mt-2 text-xs text-muted-foreground">
    ...
    return (
      <div className="space-y-4">
        <div className="rounded-lg bg-foreground/5 p-3 sm:p-4">
          ...
          <div className="font-mono text-sm sm:text-base text-foreground">
            Safe Load = <span className="text-foreground font-semibold">LOWEST</span> of:
          </div>
